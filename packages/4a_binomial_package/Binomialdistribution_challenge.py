...
class Binomial(Distribution):
    ...
    Attributes:
        ...
        data file p (float) representing the probability of an event occurring
    ...
    def __init__(self, prob=0.5, size=20):
        ...
        # You can use the calculate_mean() and calculate_stdev() methods
        # defined below along with the __init__ function from the
        # Distribution class
        Distribution.__init__(self, mu, sigma)

    # TODO: write a method calculate_mean() according to the specifications
    # below
    ...
    # class can read in a data file. Because the Binomaildistribution class
    # inherits from the Generaldistribution class, you don't need to re-write
    # this method. However,  the method doesn't update the mean or standard
    # deviation of a distribution. Hence you are going to write a method that
    # calculates n, p, mean and standard deviation from a data set and then
    # updates the n, p, mean and stdev attributes. Assume that the data is a
    # list of zeros and ones like [0 1 0 1 1 0 1].
    #
    #       Write code that:
    ...
    def replace_stats_with_data(self):
        """Function to calculate p and n from the data set. The function
        updates the p and n variables of the object.
