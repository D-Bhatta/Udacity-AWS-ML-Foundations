...
class Pants(object):
    ...
    def discount(self, discount_val):
        #    Args:
        #        discount_val (float): a decimal value for the discount.
        #            For example 0.05 for a 5% discount.
        #
        #    Returns:
        #        float: the discounted price
        return self.price * (1 - discount_val)
...
class SalesPerson(object):
    ...
    def calculate_sales(self):
        ...
        #
        ###
        total_sales = sum(pants.price for pants in self.pants_sold)
        return total_sales
